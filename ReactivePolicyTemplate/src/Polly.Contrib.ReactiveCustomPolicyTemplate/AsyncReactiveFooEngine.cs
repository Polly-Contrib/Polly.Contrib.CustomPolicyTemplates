...
{
    internal static class AsyncReactiveFooEngine
    {
        internal static async Task<TResult> ImplementationAsync<TResult>(
            ...
            bool continueOnCapturedContext, // Whether to continue executions on captured context (ConfigureAwait(...)); defaults to false, if not user-specified.
            ...
            )
        {
             ...
             *
             * A Reactive policy handles exceptions and results.  For policies not handling exceptions, see AsyncProactiveFooPolicy.
             *
